...
const SearchBar = ({ sItem }) => {
  ...
  return (
    <div className="w-full">
      ...
      {/* Droup down menu container */}
      <div className='flex space-x-2'>

      {/* Ratings droup down menu */}
      <div className=''>
      ...
      <span className='text-black text-[20px] ml-2 font-bold'>Menu Categories</span>
      <span className='text-black font-semibold text-[14px] ml-2'>Select your favorites!</span>
      </div>
